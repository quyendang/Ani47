...
namespace Movie10
{
    ...
    sealed partial class App : Application
    {
        ...
        {
            for (; element != null; element = VisualTreeHelper.GetChild(element, 0))
            {
                if (element is T)
                    return element as T;
            }
        ...
        public static VisualStateGroup FindVisualState(FrameworkElement element, string name)
        {
            if (element == null)
                return null;
            foreach (VisualStateGroup visualStateGroup in VisualStateManager.GetVisualStateGroups(element))
            {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame.Content == null)
            {
                ...
                {
                    rootFrame.Navigate(typeof(MobileMain), e.Arguments);
                }
                else
                {
